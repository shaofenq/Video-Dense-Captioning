...
class EncoderDecoder(nn.Module):
    def __init__(self, opt):
        ...
        self.opt = opt
        # print('in init: feature_dim ',  opt.feature_dim)
        # print('in init: hidden_dim ',  opt.hidden_dim)
    ...
    def forward_hrnn(self, dt, mode='train', loader=None):
        ...
        if hasattr(self, 'frame_reduce_dim_layer'):
            ...
            # print('dt video tensor shape ', dt['video_tensor'].shape)
            tmp = dt['video_tensor'].reshape(vid_num * vid_len, -1)
            print('vid num: ', vid_num, 'vid len: ', vid_len , ' tmp shape: ', tmp.shape)
